...
function seedDB(db) {
  ...
  db.GreeterProfile = [
    ...
    { id: 'g6', user_id: 'u-g6', email: 'clara@neuland.de', full_name: 'Clara Vogt', phone: '+49 151 11110006', city: 'München', languages: ['Deutsch', 'Englisch', 'Spanisch'], availability: 'flexible', status: 'on_mission', rating: 4.9, completed_missions: 22 },
    ...
    { id: 'g8', user_id: 'u-g8', email: 'yusuf@neuland.de', full_name: 'Yusuf Demir', phone: '+49 151 11110008', city: 'Frankfurt', languages: ['Deutsch', 'Englisch', 'Türkisch'], availability: 'flexible', status: 'on_mission', rating: 4.7, completed_missions: 16 },
    { id: 'g9', user_id: 'u-g9', email: 'nadia@neuland.de', full_name: 'Nadia Bauer', phone: '+49 151 11110009', city: 'Köln', languages: ['Deutsch', 'Englisch', 'Arabisch'], availability: 'weekends', status: 'break', rating: 4.6, completed_missions: 8 },
    { id: 'g10', user_id: 'u-g10', email: 'hannah@neuland.de', full_name: 'Hannah Roth', phone: '+49 151 11110010', city: 'Stuttgart', languages: ['Deutsch', 'Englisch'], availability: 'flexible', status: 'on_mission', rating: 4.8, completed_missions: 13 },
  ];
