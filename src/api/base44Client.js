...
function seedDB(db) {
  ...
  db.GreeterProfile = [
    ...
    { id: 'g5', user_id: 'u-g5', email: 'jonas@neuland.de', full_name: 'Jonas Weber', phone: '+49 151 11110005', city: 'Berlin', languages: ['Deutsch', 'Englisch'], availability: 'flexible', status: 'on_mission', rating: 4.8, completed_missions: 18 },
    { id: 'g6', user_id: 'u-g6', email: 'nico@neuland.de', full_name: 'Nico Karam', phone: '+49 151 11110006', city: 'München', languages: ['Deutsch', 'Englisch', 'Arabisch'], availability: 'flexible', status: 'on_mission', rating: 4.9, completed_missions: 22 },
    { id: 'g7', user_id: 'u-g7', email: 'david@neuland.de', full_name: 'David Schmitt', phone: '+49 151 11110007', city: 'Stuttgart', languages: ['Deutsch', 'Englisch'], availability: 'evenings', status: 'on_mission', rating: 4.5, completed_missions: 11 },
    { id: 'g8', user_id: 'u-g8', email: 'bassem@neuland.de', full_name: 'Bassem Kamel', phone: '+49 151 11110008', city: 'Frankfurt', languages: ['Deutsch', 'Englisch', 'Arabisch'], availability: 'flexible', status: 'on_mission', rating: 4.7, completed_missions: 16 },
    { id: 'g9', user_id: 'u-g9', email: 'omar@neuland.de', full_name: 'Omar Ismail', phone: '+49 151 11110009', city: 'Leipzig', languages: ['Deutsch', 'Englisch', 'Arabisch'], availability: 'weekends', status: 'break', rating: 4.6, completed_missions: 8 },
    { id: 'g10', user_id: 'u-g10', email: 'sertan@neuland.de', full_name: 'Sertan Cakar', phone: '+49 151 11110010', city: 'Frankfurt', languages: ['Deutsch', 'Englisch', 'Türkisch'], availability: 'flexible', status: 'on_mission', rating: 4.8, completed_missions: 13 },
  ];
  ...
  db.Candidate = [
    ...
    { id: 'ca6', full_name: 'Aarav Sharma', origin: 'Indien', country_of_origin: 'Indien', role: 'Software Engineer', city: 'Berlin', company_id: 'co2', arrival_date: new Date().toISOString().slice(0, 10), arrival_time: new Date(Date.now() + 2.5 * 3600000).toISOString(), flight_no: 'AI 119', languages: ['Englisch'], phone: '+49 151 33330006', status: 'in_progress', progress: 30 },
    { id: 'ca7', full_name: 'Mei Chen', origin: 'China', country_of_origin: 'China', role: 'Data Scientist', city: 'München', company_id: 'co1', arrival_date: new Date().toISOString().slice(0, 10), arrival_time: new Date(Date.now() - 20 * 60000).toISOString(), flight_no: 'LH 723', languages: ['Englisch', 'Chinesisch'], phone: '+49 151 33330007', status: 'in_progress', progress: 50 },
    { id: 'ca8', full_name: 'Carlos Ruiz', origin: 'Spanien', country_of_origin: 'Spanien', role: 'Maschinenbauingenieur', city: 'Stuttgart', company_id: 'co2', arrival_date: new Date().toISOString().slice(0, 10), arrival_time: new Date(Date.now() - 60 * 60000).toISOString(), flight_no: 'IB 357', languages: ['Englisch', 'Spanisch'], phone: '+49 151 33330008', status: 'in_progress', progress: 65 },
    { id: 'ca9', full_name: 'Fatima Noor', origin: 'Ägypten', country_of_origin: 'Ägypten', role: 'UX Designerin', city: 'Frankfurt', company_id: 'co3', arrival_date: new Date().toISOString().slice(0, 10), arrival_time: new Date(Date.now() - 3 * 3600000).toISOString(), flight_no: 'MS 785', languages: ['Englisch', 'Arabisch'], phone: '+49 151 33330009', status: 'in_progress', progress: 75 },
    { id: 'ca10', full_name: 'Ivan Petrov', origin: 'Bulgarien', country_of_origin: 'Bulgarien', role: 'Pflegefachkraft', city: 'Köln', company_id: 'co1', arrival_date: new Date().toISOString().slice(0, 10), arrival_time: new Date(Date.now() - 5 * 3600000).toISOString(), flight_no: 'FB 412', languages: ['Englisch', 'Russisch'], phone: '+49 151 33330010', status: 'in_progress', progress: 80 },
    { id: 'ca11', full_name: 'Sara Okoye', origin: 'Nigeria', country_of_origin: 'Nigeria', role: 'Projektmanagerin', city: 'Hamburg', company_id: 'co3', arrival_date: new Date().toISOString().slice(0, 10), arrival_time: new Date(Date.now() + 60 * 60000).toISOString(), flight_no: 'LH 591', languages: ['Englisch'], phone: '+49 151 33330011', status: 'in_progress', progress: 35 },
    { id: 'ca12', full_name: 'Diego Alvarez', origin: 'Mexiko', country_of_origin: 'Mexiko', role: 'DevOps Engineer', city: 'Berlin', company_id: 'co2', arrival_date: new Date().toISOString().slice(0, 10), arrival_time: new Date(Date.now() - 2 * 3600000).toISOString(), flight_no: 'AM 027', languages: ['Englisch', 'Spanisch'], phone: '+49 151 33330012', status: 'in_progress', progress: 60 },
  ];
  ...
  db.Mission = [
    ...
    // Laufende Einsätze (live) — verschiedene Stadien & Städte zum Testen des Dashboards
    { id: 'm13', title: 'Flughafenabholung Berlin', description: 'Aarav Sharma am BER abholen', company_id: 'co2', candidate_id: 'ca6', greeter_id: 'g5', status: 'accepted', greeter_stage: 'accepted', city: 'Berlin', location: 'BER Airport, Terminal 1', datetime: new Date(Date.now() + 2.5 * 3600000).toISOString(), requirements: { languages: ['Englisch'] }, pay: 90, matched_greeters: ['g5'], created_at: new Date(Date.now() - 3600000 * 6).toISOString() },
    { id: 'm14', title: 'Abholung & Transfer München', description: 'Mei Chen, Transfer nach Schwabing', company_id: 'co1', candidate_id: 'ca7', greeter_id: 'g6', status: 'on_the_way', greeter_stage: 'on_the_way', city: 'München', location: 'MUC Terminal 2', datetime: new Date(Date.now() - 20 * 60000).toISOString(), eta_at: new Date(Date.now() + 25 * 60000).toISOString(), requirements: { languages: ['Englisch'] }, pay: 95, matched_greeters: ['g6'], created_at: new Date(Date.now() - 3600000 * 8).toISOString() },
    { id: 'm15', title: 'Welcome & Stadtorientierung Stuttgart', description: 'Carlos Ruiz, Treffpunkt Hauptbahnhof', company_id: 'co2', candidate_id: 'ca8', greeter_id: 'g7', status: 'arrived', greeter_stage: 'arrived', city: 'Stuttgart', location: 'Stuttgart Hauptbahnhof', datetime: new Date(Date.now() - 60 * 60000).toISOString(), requirements: { languages: ['Englisch', 'Spanisch'] }, pay: 100, matched_greeters: ['g7'], created_at: new Date(Date.now() - 3600000 * 10).toISOString() },
    { id: 'm16', title: 'Behördengang & Bankkonto Frankfurt', description: 'Fatima Noor, Anmeldung + Konto', company_id: 'co3', candidate_id: 'ca9', greeter_id: 'g8', status: 'in_progress', greeter_stage: 'in_progress', city: 'Frankfurt', location: 'Bürgeramt Frankfurt-Mitte', datetime: new Date(Date.now() - 3 * 3600000).toISOString(), requirements: { languages: ['Englisch'] }, pay: 105, matched_greeters: ['g8'], created_at: new Date(Date.now() - 3600000 * 26).toISOString() },
    { id: 'm17', title: 'Onboarding-Woche Köln', description: 'Ivan Petrov, Wohnung + SIM + Behörden', company_id: 'co1', candidate_id: 'ca10', greeter_id: 'g3', status: 'in_progress', greeter_stage: 'in_progress', city: 'Köln', location: 'Köln Ehrenfeld', datetime: new Date(Date.now() - 5 * 3600000).toISOString(), requirements: { languages: ['Englisch'] }, pay: 115, matched_greeters: ['g3'], created_at: new Date(Date.now() - 3600000 * 30).toISOString() },
    { id: 'm18', title: 'Flughafenabholung Hamburg', description: 'Sara Okoye, Ankunft HAM', company_id: 'co3', candidate_id: 'ca11', greeter_id: 'g4', status: 'accepted', greeter_stage: 'accepted', city: 'Hamburg', location: 'HAM Airport, Ankunft', datetime: new Date(Date.now() + 60 * 60000).toISOString(), requirements: { languages: ['Englisch'] }, pay: 90, matched_greeters: ['g4'], created_at: new Date(Date.now() - 3600000 * 5).toISOString() },
    { id: 'm19', title: 'Abholung Berlin (2. Schicht)', description: 'Diego Alvarez, Talent nicht am Gate', company_id: 'co2', candidate_id: 'ca12', greeter_id: 'g10', status: 'in_progress', greeter_stage: 'arrived', city: 'Berlin', location: 'BER Terminal 1, Ausgang B', datetime: new Date(Date.now() - 2 * 3600000).toISOString(), requirements: { languages: ['Englisch', 'Spanisch'] }, pay: 95, matched_greeters: ['g10'], has_issue: true, issue_severity: 'warning', issue_message: 'Talent nicht am Gate, telefonisch erreicht — 15 Min Verspätung', created_at: new Date(Date.now() - 3600000 * 4).toISOString() },
  ];
  ...
  db.JourneyStep = [];
  ['m1', 'm2', 'm4', 'm16', 'm17', 'm19'].forEach((mid) => {
    const total = journeyTemplate.length;
    const done = mid === 'm4' ? total : mid === 'm1' ? 3 : mid === 'm17' ? 5 : mid === 'm16' ? 4 : 2;
