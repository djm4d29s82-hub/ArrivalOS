...
function seedDB(db) {
  ...
  db.GreeterProfile = [
    ...
    { id: 'g5', user_id: 'u-g5', email: 'jonas@neuland.de', full_name: 'Jonas Weber', phone: '+49 151 11110005', city: 'Berlin', languages: ['Deutsch', 'Englisch'], availability: 'flexible', status: 'busy', rating: 4.8, completed_missions: 18 },
    { id: 'g6', user_id: 'u-g6', email: 'nico@neuland.de', full_name: 'Nico Karam', phone: '+49 151 11110006', city: 'München', languages: ['Deutsch', 'Englisch', 'Arabisch'], availability: 'flexible', status: 'busy', rating: 4.9, completed_missions: 22 },
    { id: 'g7', user_id: 'u-g7', email: 'david@neuland.de', full_name: 'David Schmitt', phone: '+49 151 11110007', city: 'Stuttgart', languages: ['Deutsch', 'Englisch'], availability: 'evenings', status: 'busy', rating: 4.5, completed_missions: 11 },
    { id: 'g8', user_id: 'u-g8', email: 'bassem@neuland.de', full_name: 'Bassem Kamel', phone: '+49 151 11110008', city: 'Frankfurt', languages: ['Deutsch', 'Englisch', 'Arabisch'], availability: 'flexible', status: 'busy', rating: 4.7, completed_missions: 16 },
    { id: 'g9', user_id: 'u-g9', email: 'omar@neuland.de', full_name: 'Omar Ismail', phone: '+49 151 11110009', city: 'Leipzig', languages: ['Deutsch', 'Englisch', 'Arabisch'], availability: 'weekends', status: 'offline', rating: 4.6, completed_missions: 8 },
    { id: 'g10', user_id: 'u-g10', email: 'sertan@neuland.de', full_name: 'Sertan Cakar', phone: '+49 151 11110010', city: 'Frankfurt', languages: ['Deutsch', 'Englisch', 'Türkisch'], availability: 'flexible', status: 'busy', rating: 4.8, completed_missions: 13 },
  ];
