        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2.5 mb-5">
            <svg viewBox="0 0 64 64" className="w-10 h-10" aria-hidden="true">
              <defs><linearGradient id="agLogin" x1="0" y1="0" x2="0" y2="1">
              ...
              <path d="M8 58 L32 5 L56 58" fill="none" stroke="url(#agLogin)" strokeWidth="7" strokeLinejoin="round"/>
              <path d="M32 26 l1.9 6.1 6.1 1.9 -6.1 1.9 -1.9 6.1 -1.9 -6.1 -6.1 -1.9 6.1 -1.9 Z" fill="url(#agLogin)"/>
              <path d="M5 52 Q33 41.5 59 49.5" fill="none" stroke="url(#agLogin)" strokeWidth="2.6" strokeLinecap="round"/>
